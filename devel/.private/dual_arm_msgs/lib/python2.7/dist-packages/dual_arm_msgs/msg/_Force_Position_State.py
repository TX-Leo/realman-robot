...
"""autogenerated by genpy from dual_arm_msgs/Force_Position_State.msg. Do not edit."""
import codecs
import sys
...
class Force_Position_State(genpy.Message):
  _md5sum = "3dfce38cb0562062290b24383d516d1c"
  _type = "dual_arm_msgs/Force_Position_State"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """float32[6] joint
float32 force
uint16 arm_err
"""
  __slots__ = ['joint','force','arm_err']
  _slot_types = ['float32[6]','float32','uint16']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_fH().pack(_x.force, _x.arm_err))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.force, _x.arm_err,) = _get_struct_fH().unpack(str[start:end])
      return self
