...
(cl:defmethod cl:initialize-instance :after ((m <ArmState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<ArmState> is deprecated: use dual_arm_msgs-msg:ArmState instead.")))
