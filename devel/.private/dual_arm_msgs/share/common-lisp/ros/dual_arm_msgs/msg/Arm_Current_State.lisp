...
(cl:defmethod cl:initialize-instance :after ((m <Arm_Current_State>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Arm_Current_State)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Arm_Current_State> is deprecated: use dual_arm_msgs-msg:Arm_Current_State instead.")))
...
(cl:defmethod Pose-val ((m <Arm_Current_State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:Pose-val is deprecated.  Use dual_arm_msgs-msg:Pose instead.")
  (Pose m))

(cl:ensure-generic-function 'arm_err-val :lambda-list '(m))
(cl:defmethod arm_err-val ((m <Arm_Current_State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:arm_err-val is deprecated.  Use dual_arm_msgs-msg:arm_err instead.")
  (arm_err m))

(cl:ensure-generic-function 'sys_err-val :lambda-list '(m))
(cl:defmethod sys_err-val ((m <Arm_Current_State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:sys_err-val is deprecated.  Use dual_arm_msgs-msg:sys_err instead.")
  (sys_err m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Arm_Current_State>)))
  ...
  "dual_arm_msgs/Arm_Current_State")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Arm_Current_State)))
  "Returns string type for a message object of type 'Arm_Current_State"
  "dual_arm_msgs/Arm_Current_State")
