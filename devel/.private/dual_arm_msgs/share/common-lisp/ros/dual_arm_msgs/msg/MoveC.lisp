...
(cl:defmethod cl:initialize-instance :after ((m <MoveC>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveC)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<MoveC> is deprecated: use dual_arm_msgs-msg:MoveC instead.")))

(cl:ensure-generic-function 'Mid_Pose-val :lambda-list '(m))
(cl:defmethod Mid_Pose-val ((m <MoveC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:Mid_Pose-val is deprecated.  Use dual_arm_msgs-msg:Mid_Pose instead.")
  (Mid_Pose m))

(cl:ensure-generic-function 'End_Pose-val :lambda-list '(m))
(cl:defmethod End_Pose-val ((m <MoveC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:End_Pose-val is deprecated.  Use dual_arm_msgs-msg:End_Pose instead.")
  (End_Pose m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <MoveC>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:speed-val is deprecated.  Use dual_arm_msgs-msg:speed instead.")
  (speed m))
