...
(cl:defmethod cl:initialize-instance :after ((m <Joint_Current>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joint_Current)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Joint_Current> is deprecated: use dual_arm_msgs-msg:Joint_Current instead.")))

(cl:ensure-generic-function 'joint_current-val :lambda-list '(m))
(cl:defmethod joint_current-val ((m <Joint_Current>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:joint_current-val is deprecated.  Use dual_arm_msgs-msg:joint_current instead.")
  (joint_current m))
