...
(cl:defmethod cl:initialize-instance :after ((m <Tool_IO_State>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Tool_IO_State)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Tool_IO_State> is deprecated: use dual_arm_msgs-msg:Tool_IO_State instead.")))

(cl:ensure-generic-function 'Tool_Digital_Input-val :lambda-list '(m))
(cl:defmethod Tool_Digital_Input-val ((m <Tool_IO_State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:Tool_Digital_Input-val is deprecated.  Use dual_arm_msgs-msg:Tool_Digital_Input instead.")
...
(cl:defmethod Tool_Analog_Input-val ((m <Tool_IO_State>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:Tool_Analog_Input-val is deprecated.  Use dual_arm_msgs-msg:Tool_Analog_Input instead.")
  (Tool_Analog_Input m))
