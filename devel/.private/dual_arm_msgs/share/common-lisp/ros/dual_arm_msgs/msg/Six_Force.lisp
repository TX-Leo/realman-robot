...
(cl:defmethod cl:initialize-instance :after ((m <Six_Force>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Six_Force)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Six_Force> is deprecated: use dual_arm_msgs-msg:Six_Force instead.")))
