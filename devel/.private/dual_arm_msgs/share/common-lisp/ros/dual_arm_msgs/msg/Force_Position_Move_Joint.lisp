...
(cl:defmethod cl:initialize-instance :after ((m <Force_Position_Move_Joint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Force_Position_Move_Joint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Force_Position_Move_Joint> is deprecated: use dual_arm_msgs-msg:Force_Position_Move_Joint instead.")))

(cl:ensure-generic-function 'joint-val :lambda-list '(m))
(cl:defmethod joint-val ((m <Force_Position_Move_Joint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:joint-val is deprecated.  Use dual_arm_msgs-msg:joint instead.")
  (joint m))

(cl:ensure-generic-function 'sensor-val :lambda-list '(m))
(cl:defmethod sensor-val ((m <Force_Position_Move_Joint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:sensor-val is deprecated.  Use dual_arm_msgs-msg:sensor instead.")
  (sensor m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <Force_Position_Move_Joint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:mode-val is deprecated.  Use dual_arm_msgs-msg:mode instead.")
  (mode m))

(cl:ensure-generic-function 'dir-val :lambda-list '(m))
(cl:defmethod dir-val ((m <Force_Position_Move_Joint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:dir-val is deprecated.  Use dual_arm_msgs-msg:dir instead.")
  (dir m))

(cl:ensure-generic-function 'force-val :lambda-list '(m))
(cl:defmethod force-val ((m <Force_Position_Move_Joint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:force-val is deprecated.  Use dual_arm_msgs-msg:force instead.")
  (force m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Force_Position_Move_Joint>)))
  ...
  "dual_arm_msgs/Force_Position_Move_Joint")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Force_Position_Move_Joint)))
  "Returns string type for a message object of type 'Force_Position_Move_Joint"
  "dual_arm_msgs/Force_Position_Move_Joint")
