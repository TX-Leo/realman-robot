...
(cl:defmethod cl:initialize-instance :after ((m <MoveJ_P>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MoveJ_P)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<MoveJ_P> is deprecated: use dual_arm_msgs-msg:MoveJ_P instead.")))
