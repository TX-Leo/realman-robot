...
(cl:defmethod cl:initialize-instance :after ((m <CartePos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CartePos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<CartePos> is deprecated: use dual_arm_msgs-msg:CartePos instead.")))
