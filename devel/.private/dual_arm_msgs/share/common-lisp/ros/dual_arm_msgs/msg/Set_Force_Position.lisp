...
(cl:defmethod cl:initialize-instance :after ((m <Set_Force_Position>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Set_Force_Position)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name dual_arm_msgs-msg:<Set_Force_Position> is deprecated: use dual_arm_msgs-msg:Set_Force_Position instead.")))
...
(cl:defmethod N-val ((m <Set_Force_Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:N-val is deprecated.  Use dual_arm_msgs-msg:N instead.")
  (N m))

(cl:ensure-generic-function 'load-val :lambda-list '(m))
(cl:defmethod load-val ((m <Set_Force_Position>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader dual_arm_msgs-msg:load-val is deprecated.  Use dual_arm_msgs-msg:load instead.")
  (load m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Set_Force_Position>)))
  ...
  "dual_arm_msgs/Set_Force_Position")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Set_Force_Position)))
  "Returns string type for a message object of type 'Set_Force_Position"
  "dual_arm_msgs/Set_Force_Position")
