...
class GetArmState_Command {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GetArmState_Command(null);
  ...
  static datatype() {
    ...
    return 'dual_arm_msgs/GetArmState_Command';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetArmState_Command(null);
...
module.exports = GetArmState_Command;
