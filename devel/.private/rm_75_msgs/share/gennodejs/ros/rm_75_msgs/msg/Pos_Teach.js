...
class Pos_Teach {
  ...
  static getMessageSize(object) {
    let length = 0;
    length += object.teach_type.length;
  ...
  static Resolve(msg) {
    ...
    const resolved = new Pos_Teach(null);
