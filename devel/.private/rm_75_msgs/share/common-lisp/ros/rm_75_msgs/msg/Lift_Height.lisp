...
(cl:defmethod cl:initialize-instance :after ((m <Lift_Height>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Lift_Height)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rm_75_msgs-msg:<Lift_Height> is deprecated: use rm_75_msgs-msg:Lift_Height instead.")))

(cl:ensure-generic-function 'height-val :lambda-list '(m))
(cl:defmethod height-val ((m <Lift_Height>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rm_75_msgs-msg:height-val is deprecated.  Use rm_75_msgs-msg:height instead.")
  (height m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <Lift_Height>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rm_75_msgs-msg:speed-val is deprecated.  Use rm_75_msgs-msg:speed instead.")
  (speed m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Lift_Height>)))
  ...
  (cl:format cl:nil "#升降机构运行到指定高度~%int16 height        #目标高度，单位 mm，范围：0~~2600~%int16 speed         #速度百分比，1~~100~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Lift_Height)))
  "Returns full string definition for message of type 'Lift_Height"
  (cl:format cl:nil "#升降机构运行到指定高度~%int16 height        #目标高度，单位 mm，范围：0~~2600~%int16 speed         #速度百分比，1~~100~%~%~%"))
