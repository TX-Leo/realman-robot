...
(cl:defmethod cl:initialize-instance :after ((m <Joint_Teach>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joint_Teach)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rm_75_msgs-msg:<Joint_Teach> is deprecated: use rm_75_msgs-msg:Joint_Teach instead.")))

(cl:ensure-generic-function 'teach_joint-val :lambda-list '(m))
(cl:defmethod teach_joint-val ((m <Joint_Teach>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rm_75_msgs-msg:teach_joint-val is deprecated.  Use rm_75_msgs-msg:teach_joint instead.")
  (teach_joint m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Joint_Teach>)))
  ...
  (cl:format cl:nil "#关节示教~%int16 teach_joint         #关节序号 1~~7~%string direction	  #方向，”pos”:正方向，”neg”：反方向~%int16 v			  #速度系数 1~~100~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Joint_Teach)))
  "Returns full string definition for message of type 'Joint_Teach"
  (cl:format cl:nil "#关节示教~%int16 teach_joint         #关节序号 1~~7~%string direction	  #方向，”pos”:正方向，”neg”：反方向~%int16 v			  #速度系数 1~~100~%~%~%"))
