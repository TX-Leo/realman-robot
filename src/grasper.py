...
class Grasper:
    def __init__(self,camera,robot,rgb_img,depth_img,checkpoint_path):
        '''
        camera:
        robot:
        rgb_img
    ...
    def get_real_grasp(self,gg):
        # grasp pose transform
        cam2robot = self.robot.cam_pose
        ...
        rpy_grasp2robot = self.robot.R2rpy(R_grasp2robot)
