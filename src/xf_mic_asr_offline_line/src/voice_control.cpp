...
int main(int argc, char *argv[])
{
	...
	ndHandle.param("source_path", source_path, std::string("/home/rm/catkin_ws/src/xf_mic_asr_offline_line"));
	ndHandle.param("/appid", appid, std::string("9f9d14f8"));//appid，需要更换为自己的
