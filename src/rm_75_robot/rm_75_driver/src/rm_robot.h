...
#include <ros/ros.h>
//messgae
#include <rm_75_msgs/Arm_Analog_Output.h>
#include <rm_75_msgs/Arm_Digital_Output.h>
#include <rm_75_msgs/Arm_IO_State.h>
#include <rm_75_msgs/Gripper_Pick.h>
#include <rm_75_msgs/Gripper_Set.h>
#include <rm_75_msgs/Joint_Enable.h>
#include <rm_75_msgs/JointPos.h>
#include <rm_75_msgs/MoveC.h>
#include <rm_75_msgs/MoveJ.h>
#include <rm_75_msgs/MoveL.h>
#include <rm_75_msgs/Tool_Analog_Output.h>
#include <rm_75_msgs/Tool_Digital_Output.h>
#include <rm_75_msgs/Tool_IO_State.h>
#include <rm_75_msgs/Plan_State.h>
#include <rm_75_msgs/Stop.h>
#include <rm_75_msgs/IO_Update.h>

#include <rm_75_msgs/Turtle_Driver.h>
#include <std_msgs/String.h>
#include <rm_75_msgs/Lift_Height.h>
#include <rm_75_msgs/Lift_Speed.h>
#include <rm_75_msgs/Joint_Teach.h>
#include <rm_75_msgs/Pos_Teach.h>
#include <rm_75_msgs/Stop_Teach.h>

#include <rm_75_msgs/Hand_Angle.h>
#include <rm_75_msgs/Hand_Force.h>
#include <rm_75_msgs/Hand_Posture.h>
#include <rm_75_msgs/Hand_Seq.h>
#include <rm_75_msgs/Hand_Speed.h>
...
/***** ********************************START***************************************
 * 20211201修改: 增加对五指灵巧手的配置相关
 * *********************************************************************************/
ros::Subscriber sub_setHandPosture, sub_setHandSeq, sub_setHandAngle, sub_setHandSpeed, sub_setHandForce;
 /***** ********************************END****************************************/

/***** ********************************START***************************************
 * 20211201修改: 增加对海龟底盘,升降控制,机械臂示教相关
 * *********************************************************************************/
ros::Subscriber sub_setJointTeach, sub_setPosTeach, sub_setStopTeach;

ros::Subscriber sub_setLiftSpeed;
ros::Subscriber sub_lift_setHeight;
...
/***** ********************************START***************************************
 * 20211201修改: 增加对机械臂的关节示教,位置示教和示教停止
 * *********************************************************************************/
//发送控制机械臂关节示教的指令
