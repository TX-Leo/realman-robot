...
class Arm:
    def __init__(self, host_ip, host_port, home_state=None, workspace_limits=None,is_use_robotiq85=True, is_use_camera=True):
        self.host_ip = host_ip
        self.host_port = host_port
        # Init varibles
        if workspace_limits is None:
            self.workspace_limits = [[-0.7, 0.7], [-0.7, 0.7], [0.00, 0.6]]
        else:
